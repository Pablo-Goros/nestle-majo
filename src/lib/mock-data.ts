...
export const ROLE_ACCESS: Record<Role, { canEdit: string[]; canView: string[] }> = {
  ...
  marketing: {
    canView: ["dashboard", "datos", "forecast", "insights", "consenso", "suministro", "mbp", "ai"],
    canEdit: ["insights"],
  },
  ventas: {
    canView: ["dashboard", "datos", "forecast", "insights", "consenso", "suministro", "mbp", "ai"],
...
export const MOCK_OUTLIERS = [
  ...
  {
    fecha: "2025-01-15",
    producto: "Nesquik 800g",
    valor: 5800,
    esperado: 4200,
    zscore: 2.8,
    evento: "Vuelta a clases",
    tipo: "estructural",
  },
  {
    fecha: "2024-09-30",
    producto: "Nescafé Gold 200g",
    valor: 1200,
    esperado: 3800,
    zscore: -3.5,
    evento: "Quiebre de stock",
    tipo: "coyuntural",
  },
  {
    fecha: "2025-03-31",
    producto: "Maggi Sopa Pollo",
    valor: 6200,
    esperado: 3900,
    zscore: 3.1,
    evento: "Cierre de trimestre",
    tipo: "coyuntural",
  },
  {
    fecha: "2024-12-20",
...
export const MOCK_INSIGHTS = [
  {
    ...
    tipo: "Hot Sale",
    estado: "Aprobado",
    justificacion: "Campaña Hot Sale con 25% off + push paid media.",
  },
  {
    id: 2,
    area: "Ventas",
    ...
    fin: "2025-06-30",
    impacto: "-1200u",
    tipo: "Traba comercial",
    estado: "Pendiente",
    justificacion: "Coto en negociación de listado, riesgo de pausar reposición.",
  },
  {
    id: 3,
    area: "Finanzas",
    responsable: "Carla Mora",
    sku: "Milo 3kg",
    canal: "Todos",
    inicio: "2025-06-01",
    fin: "2025-06-30",
    ...
    tipo: "Inflación",
    estado: "Aprobado",
    justificacion: "Ajuste de precio +8% impacta elasticidad estimada.",
  },
  {
    id: 4,
    area: "Marketing",
    ...
    fin: "2025-08-15",
    impacto: "+15%",
    tipo: "Vuelta a clases",
    estado: "Aprobado",
    justificacion: "Activación BTL + descuento pack escolar.",
  },
  {
    id: 5,
    area: "Ventas",
    ...
    tipo: "Sell-in",
    estado: "En revisión",
    justificacion: "Compra extraordinaria Maxiconsumo Córdoba.",
  },
];
...
export const MOCK_ALERTS = [
  {
    ...
    sku: "Nescafé Gold 200g",
    canal: "Supermercados",
    tipo: "Stockout proyectado",
    severidad: "alta",
    recomendacion: "Acelerar reposición desde CD Pilar. Cobertura proyectada: 4 días.",
  ...
  },
  {
    ...
    sku: "Kit Kat 40g",
    canal: "E-commerce",
    tipo: "Desvío consenso vs baseline > 20%",
    severidad: "media",
    recomendacion: "Revisar insight de Hot Sale, validar con Marketing.",
  ...
  },
  {
    ...
    sku: "Milo 3kg",
    canal: "Mayoristas",
    tipo: "Bias fuera de rango",
    severidad: "media",
    recomendacion: "Modelo sobreestimando. Considerar Holt-Winters.",
    responsable: "Demand Planner",
  },
  {
    id: 4,
    sku: "Nesquik 800g",
    canal: "Todos",
    tipo: "DPA bajo umbral (78%)",
    severidad: "alta",
    recomendacion: "Revisar limpieza de outliers de marzo.",
    responsable: "Demand Planner",
  },
  {
    id: 5,
    ...
    tipo: "SKU crítico sin insight cargado",
    severidad: "baja",
    recomendacion: "Solicitar input a Ventas antes del consenso.",
    responsable: "Ventas",
  },
  {
    id: 6,
    sku: "Nescafé Tradición 500g",
    canal: "Todos",
    tipo: "Margen bajo target",
    severidad: "media",
    recomendacion: "Evaluar ajuste de precio o mix de canal.",
...
export const MBP_TASKS = [
  {
    semana: 1,
    titulo: "Limpieza de datos y baseline",
    tareas: [
  ...
  {
    semana: 2,
    titulo: "Inputs de Ventas, Marketing y Finanzas",
    tareas: [
  ...
  {
    semana: 4,
    titulo: "Publicación y revisión ejecutiva",
    tareas: [
